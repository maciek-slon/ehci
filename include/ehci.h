...
DllExport int ehciLoop(int mode, int initialGuess);
DllExport int ehciLoop(int mode,int initialGuess,IplImage* createdImage);

DllExport void getHeadBounds(int* headRefX,int* headRefY,int* aLastHeadW,int* aLastHeadH);
...
DllExport void getGlPositMatrix(double myGlPositMatrix[16]);


DllExport IplImage* getCurrentFrame();


DllExport void ehciExit();
